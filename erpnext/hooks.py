...
website_context = {
    "favicon": "/assets/erpnext/images/ge_final.png",
    "splash_image": "/assets/erpnext/images/ge_final.png",
}
...
standard_portal_menu_items = [
    {"title": "Projects", "route": "/project",
        "reference_doctype": "Project", "role": "Customer"},
    {
    ...
    {"title": "Issues", "route": "/issues",
        "reference_doctype": "Issue", "role": "Customer"},
    ...
    {"title": "Newsletter", "route": "/newsletters",
...
sounds = [
    {"name": "incoming-call",
        "src": "/assets/erpnext/sounds/incoming-call.mp3", "volume": 0.2},
    {"name": "call-disconnect",
     "src": "/assets/erpnext/sounds/call-disconnect.mp3", "volume": 0.2},
]
...
permission_query_conditions = {
    "Update Stock": "erpnext.selling.doctype.update_stock.update_stock.get_permission_query_conditions"
}
has_permission = {
    "Update Stock": "erpnext.selling.doctype.update_stock.update_stock.has_permission"
}
